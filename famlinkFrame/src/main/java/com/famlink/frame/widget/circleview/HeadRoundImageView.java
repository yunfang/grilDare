package com.famlink.frame.widget.circleview;
...
public class HeadRoundImageView extends ImageView {
    ...
    public HeadRoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public HeadRoundImageView(Context context, AttributeSet attrs, int defStyle) {
...
//圆形图片的三种用法
//	<com.famlink.frame.widget.RoundImageView
//	android:id="@+id/roundImage_network"
//	android:layout_width="60dp"
//	android:layout_height="60dp"
//	android:src="@drawable/beginners_guide_image03" />
//
//	<com.famlink.frame.widget.RoundImageView
