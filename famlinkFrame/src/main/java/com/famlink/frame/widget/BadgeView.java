...
public class BadgeView extends TextView {
    ...
    public void setTargetView(View target) {
        ...
        if (target.getParent() instanceof FrameLayout) {
        	FrameLayout fl=(FrameLayout)target.getParent();
        	ViewGroup parentContainer=(ViewGroup) fl.getParent();
        	int groupIndex = parentContainer.indexOfChild(fl);
        	ViewGroup.LayoutParams parentLayoutParams = fl.getLayoutParams();
        	fl.removeAllViews();
        	parentContainer.removeView(fl);
