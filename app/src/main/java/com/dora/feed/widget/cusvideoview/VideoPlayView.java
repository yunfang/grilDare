...
//    private OrientationEventListener orientationEventListener;
    ...
    private void initViews() {
        ...
        rView = LayoutInflater.from(activity).inflate(R.layout.view_video_item, this, true);
        view = findViewById(R.id.media_contoller);
        mVideoView = (IjkVideoView) findViewById(R.id.main_video);
        mediaController = new CustomMediaContoller(activity, rView);
        ...
        mVideoView.setOnCompletionListener(new IMediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(IMediaPlayer mp) {
                ...
                if (mediaController.getScreenOrientation(activity)
