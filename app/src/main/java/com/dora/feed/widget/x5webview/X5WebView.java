package com.dora.feed.widget.x5webview;
...
public class X5WebView extends WebView {
	...
	private WebChromeClient chromeClient = new WebChromeClient() {
		...
		public void onShowCustomView(View view, CustomViewCallback customViewCallback) {
			FrameLayout normalView = (FrameLayout) ((Activity) getContext()).findViewById(R.id.webView);
...
//			canvas.drawText(this.getContext().getPackageName() + "-pid:" + android.os.Process.myPid(), app_10, 50, paint);
//			canvas.drawText("X5  Core:" + QbSdk.getTbsVersion(this.getContext()), app_10, 100, paint);
		} else {
//			canvas.drawText(this.getContext().getPackageName() + "-pid:" + android.os.Process.myPid(), app_10, 50, paint);
//			canvas.drawText("Sys Core", app_10, 100, paint);
		}
//		canvas.drawText(Build.MANUFACTURER, app_10, 150, paint);
//		canvas.drawText(Build.MODEL, app_10, 200, paint);
		canvas.restore();
		return ret;
	}
	...
	protected void tbs_onScrollChanged(int l, int t, int oldl, int oldt, View view) {
		SysoutUtil.out("X5WebView tbs_onScrollChanged");
		super_onScrollChanged(l, t, oldl, oldt);
	}
	@Override
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		SysoutUtil.out("X5WebView onScrollChanged");
	...
	protected boolean tbs_onTouchEvent(MotionEvent event, View view) {
		...
		SysoutUtil.out("X5WebView tbs_onTouchEvent");
...
//		System.out.println("ev----" + ev.getY() + "----height----" + getHeight()+ getScrollY() + "--Scale--" + getContentHeight()* getScale());
//		//WebView的总高度
//		float webViewContentHeight= getContentHeight() * getScale();
//		//WebView的现高度
//		float webViewCurrentHeight=(getHeight() + getScrollY());
...
//				if (isTop()) {     //是否滑到顶部
//					scroll = false;
//					SysoutUtil.out("滑动到了顶部");
//				} else if (isBottom()){    //是否滑到底部
//					scroll = false;
//					SysoutUtil.out("滑动到了底部");
//				}
...
//	}
//
//	private X5InterceptTouchListener X5InterceptTouch;
//
//	public X5InterceptTouchListener getX5InterceptTouch() {
//		return X5InterceptTouch;
//	}
//
//	public void setX5InterceptTouch(X5InterceptTouchListener x5InterceptTouch) {
//		X5InterceptTouch = x5InterceptTouch;
//	}
//
//	public interface  X5InterceptTouchListener{
//		void onX5TouchListener(MotionEvent ev);
//	}
}
