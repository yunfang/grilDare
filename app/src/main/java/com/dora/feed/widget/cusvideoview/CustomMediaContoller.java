...
public class CustomMediaContoller implements IMediaController {
    ...
    public CustomMediaContoller(Activity activity, View view) {
        this.view=view;
    ...
    public void start() {
        pauseImage.setVisibility(View.GONE);
        itemView.setVisibility(View.GONE);
        play.setImageResource(R.drawable.video_ic_player_pause);
        progressBar.setVisibility(View.VISIBLE);
    }

    public void pause(){
        play.setImageResource(R.drawable.video_ic_player_play);
        videoView.pause();
...
//                        statusChange(STATUS_PLAYING);
        ...
        sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isSound) {
                    //静音
                    sound.setImageResource(R.drawable.video_ic_sound_mult_icon);
                    audioManager.setStreamMute(AudioManager.STREAM_MUSIC, true);
                } else {
                    //取消静音
                    sound.setImageResource(R.drawable.video_ic_sound_open_icon);
                    audioManager.setStreamMute(AudioManager.STREAM_MUSIC, false);
                }
                isSound = !isSound;
            }
