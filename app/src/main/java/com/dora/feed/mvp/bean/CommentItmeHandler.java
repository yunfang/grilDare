 ...
 */
public class CommentItmeHandler {

    Context context;
    List<CommentBean.Data> mList;
    private int position;
    public CommentItmeHandler(Context context, List<CommentBean.Data> list, int position) {
...
//            intent.putExtra("intentIcon",mList.get(position).getMaster_img());
//            intent.putExtra("intentReadCount",mList.get(position).getLook_num());
//            intent.putExtra("intentTime",mList.get(position).getDtime());
